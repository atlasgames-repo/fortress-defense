...
public class SpawnSystemHelperEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        (this.target as SpawnSystemHelper).from_bundle = GUILayout.Toggle((this.target as SpawnSystemHelper).from_bundle, "is loading from bundle");
        (this.target as SpawnSystemHelper).bundle_name = GUILayout.TextField((this.target as SpawnSystemHelper).bundle_name);
